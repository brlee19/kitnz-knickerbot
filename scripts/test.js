module.exports = function(robot) {
  ...
  robot.respond(/test$/i, function(res) { // "test"
    return res.send("GO NEW YORK GO NEW YORK GO!");
  });

  robot.hear(/knicks/i, function(res) { // "test"
    return res.send("GO NEW YORK GO NEW YORK GO!");
  });

  robot.hear(/clyde/i, function(res) { // "test"
    var clydeisms = [
  ...
  robot.hear(/swaggy p/i, function(res) {
  ...
  robot.hear(/uncle p/i, function(res) {
